...
!(function (i) {
  "function" == typeof define && define.amd
    ? define("viewer", ["jquery"], i)
    : i("object" == typeof exports ? require("jquery") : jQuery);
})(function (i) {
  "use strict";
  function t(i) {
  ...
  ((u.prototype = {
    ...
    init: function () {
      ...
      o &&
        (i.isFunction(t.build) && e.one(A, t.build),
    ...
    build: function () {
      ...
      this.isBuilt ||
        ...
        r.after(e),
        h.inline && (this.render(), this.bind(), (this.isShown = !0)),
        (this.isBuilt = !0),
    ...
    bind: function () {
      ...
      (i.isFunction(t.view) && e.on(Z, t.view),
        ...
        this.$viewer
          .on(_, i.proxy(this.click, this))
          .on(q, i.proxy(this.wheel, this)),
        this.$canvas.on(S, i.proxy(this.mousedown, this)),
        v
          .on(D, (this._mousemove = o(this.mousemove, this)))
          .on(L, (this._mouseup = o(this.mouseup, this)))
          .on(W, (this._keydown = o(this.keydown, this))),
    ...
    initContainer: function () {
      this.container = { width: m.innerWidth(), height: m.innerHeight() };
    },
    initViewer: function () {
      var t,
        e = this.options,
      ...
      (this.$images.each(function (s) {
        ...
        n &&
          (t(h)
            ...
            : i.isFunction(h) && (h = h.call(this, this)),
          o.push(
            '<li><img src="' +
              n +
        ...
        n
          .html(o.join(""))
          .find(E)
          .one(M, { filled: !0 }, i.proxy(this.loadImage, this)),
    ...
    resize: function () {
      (this.initContainer(),
        ...
        this.isPlayed &&
          this.$player
            .find(E)
            .one(M, i.proxy(this.loadImage, this))
            .trigger(M));
    },
    wheel: function (t) {
      var e = t.originalEvent || t,
        s = si(this.options.zoomRatio) || 0.1,
        n = 1;
      this.isViewed &&
        (t.preventDefault(),
        this.wheeling ||
        ...
        this.trigger(H).isDefaultPrevented() ||
          ...
          e.transition
            ? ((this.transitioning = !0),
              t.addClass(X),
              h(t[0]),
              t.one(R, i.proxy(this.shown, this)).addClass(F))
            : (t.addClass(F), this.shown())));
    },
    hide: function () {
      var t = this.options,
        e = this.$viewer;
      t.inline ||
        this.transitioning ||
        !this.isShown ||
        (i.isFunction(t.hide) && this.$element.one(N, t.hide),
        this.trigger(N).isDefaultPrevented() ||
          (this.isViewed && t.transition
            ? ((this.transitioning = !0),
              this.$image.one(
                R,
                i.proxy(function () {
    ...
    view: function (t) {
      ...
      ((t = Number(t) || 0),
        !this.isShown ||
          ...
          0 > t ||
          t >= this.length ||
          (this.isViewed && t === this.index) ||
          this.trigger(Z).isDefaultPrevented() ||
          ((s = this.$items.eq(t)),
          (n = s.find(E)),
          ...
          e[0].complete
            ? this.load()
            : (e.one(M, i.proxy(this.load, this)),
        ...
        e(i) &&
          ...
          s && (o = s.originalEvent)
            ? ((r = this.$viewer.offset()),
              ...
              (v.top -= (h - g) * ((l.pageY - r.top - v.top) / g)))
            : ((v.left -= (a - f) / 2), (v.top -= (h - g) / 2)),
          (v.width = a),
          (v.height = h),
          (v.ratio = i),
          this.renderImage(),
    ...
    full: function () {
      ...
      this.isShown &&
        ...
        t.transition && (e.removeClass(X), s.removeClass(X)),
    ...
    tooltip: function () {
      ...
      this.isViewed &&
        !this.isPlayed &&
        t.tooltip &&
        (e.text(G(100 * s.ratio) + "%"),
        this.tooltiping
          ? clearTimeout(this.tooltiping)
          : t.transition
            ? (this.fading && e.trigger(R),
              e.addClass(n),
              h(e[0]),
              e.addClass(F))
            : e.addClass(b),
    ...
    reset: function () {
      this.isViewed &&
        !this.isPlayed &&
        ((this.image = i.extend({}, this.initialImage)), this.renderImage());
    },
    update: function () {
      var t,
        e = this.$element,
      ...
      this.isBuilt &&
        ...
        this.isShown &&
          (this.length
            ? this.isViewed &&
              ((t = i.inArray(this.index, n)),
              t >= 0
                ? ((this.isViewed = !1), this.view(ei(this.index - (t + 1), 0)))
                : this.$items.eq(this.index).addClass(k))
            : ((this.$image = null),
              (this.isViewed = !1),
              (this.index = 0),
              (this.image = null),
    ...
    destroy: function () {
      ...
      (this.options.inline
        ? this.unbind()
        : (this.isShown && this.unbind(), i.off(_, this.start)),
        this.unbuild(),
        i.removeData(f));
    },
        ...
        case "zoom":
          (this.zoom(
            (function (i, t, e, s) {
              ...
              ii(this.startX - this.startX2),
              ii(this.startY - this.startY2),
              ii(this.endX - this.endX2),
              ii(this.endY - this.endY2),
            ),
            !1,
            i,
          ),
    ...
    isSwitchable: function () {
      var i = this.image,
        t = this.viewer;
      return (
        i.left >= 0 && i.top >= 0 && i.width <= t.width && i.height <= t.height
      );
    },
  }),
    (u.DEFAULTS = {
