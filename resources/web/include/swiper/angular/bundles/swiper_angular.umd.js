(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ...
    : typeof define === "function" && define.amd
      ? define(
          "swiper_angular",
          ["exports", "@angular/core", "@angular/common", "swiper", "rxjs"],
          factory,
        )
      : ((global =
          typeof globalThis !== "undefined" ? globalThis : global || self),
        factory(
          (global.swiper_angular = {}),
          global.ng.core,
          global.ng.common,
          global.Swiper,
          global.rxjs,
        ));
})(this, function (exports, i0, i1, Swiper, rxjs) {
  "use strict";
  ...
  var SwiperSlideDirective = /** @class */ (function () {
    ...
    SwiperSlideDirective.prototype._hasClass = function (classNames) {
      ...
      return classNames.some(function (className) {
        return _this._classNames.indexOf(className) >= 0;
      });
    };
    return SwiperSlideDirective;
  })();
  SwiperSlideDirective.ɵfac = i0__namespace.ɵɵngDeclareFactory({
    minVersion: "12.0.0",
    version: "12.2.2",
    ngImport: i0__namespace,
    type: SwiperSlideDirective,
    deps: [{ token: i0__namespace.TemplateRef }],
    target: i0__namespace.ɵɵFactoryTarget.Directive,
  });
  SwiperSlideDirective.ɵdir = i0__namespace.ɵɵngDeclareDirective({
    minVersion: "12.0.0",
    version: "12.2.2",
    type: SwiperSlideDirective,
  ...
  i0__namespace.ɵɵngDeclareClassMetadata({
    ...
    ctorParameters: function () {
      return [{ type: i0__namespace.TemplateRef }];
    },
    propDecorators: {
      virtualIndex: [
        {
  ...
  var SwiperComponent = /** @class */ (function () {
    function SwiperComponent(
      ...
      this.slidesChanges = function (val) {
        ...
        if (!_this.virtual) {
          if (_this.loopedSlides) {
            _this.prependSlides = rxjs.of(
              _this.slides.slice(_this.slides.length - _this.loopedSlides),
            );
            _this.appendSlides = rxjs.of(
              _this.slides.slice(0, _this.loopedSlides),
            );
          }
      ...
      this.updateVirtualSlides = function (virtualData) {
        ...
        _this.style = _this.swiperRef.isHorizontal()
          ? ((_d = {}),
            (_d[_this.swiperRef.rtlTranslate ? "right" : "left"] =
      ...
      set: function (val) {
        ...
        var currentNext =
          typeof this._navigation !== "boolean" && this._navigation !== ""
            ? (_a = this._navigation) === null || _a === void 0
              ? void 0
              : _a.nextEl
            : null;
        var currentPrev =
          typeof this._navigation !== "boolean" && this._navigation !== ""
            ? (_b = this._navigation) === null || _b === void 0
              ? void 0
              : _b.prevEl
            : null;
        ...
        this.showNavigation = !(
          ...
          (this._navigation &&
            ...
            this._navigation.prevEl !==
              ((_c = this._prevElRef) === null || _c === void 0
                ? void 0
                : _c.nativeElement) &&
            (this._navigation.prevEl !== null ||
              this._navigation.nextEl !== null) &&
      ...
      set: function (val) {
        ...
        var current =
          typeof this._pagination !== "boolean" && this._pagination !== ""
            ? (_a = this._pagination) === null || _a === void 0
              ? void 0
              : _a.el
            : null;
    ...
    Object.defineProperty(SwiperComponent.prototype, "scrollbar", {
      ...
      set: function (val) {
        var _a;
        var current =
          typeof this._scrollbar !== "boolean" && this._scrollbar !== ""
            ? (_a = this._scrollbar) === null || _a === void 0
              ? void 0
              : _a.el
            : null;
    ...
    Object.defineProperty(SwiperComponent.prototype, "index", {
      set: function (index) {
        console.warn(
          "`[(index)]` prop is deprecated and will be removed in upcoming versions",
        );
        this.setIndex(index);
      },
      enumerable: false,
    ...
    SwiperComponent.prototype.initSwiper = function () {
      var _this = this;
      var _d = getParams(this),
        swiperParams = _d.params,
        passedParams = _d.passedParams;
      ...
      this._ngZone.runOutsideAngular(function () {
        ...
        if (i1.isPlatformBrowser(_this._platformId)) {
          ...
          var isEnabled =
            typeof _this.swiperRef.params.virtual !== "undefined" &&
    ...
    SwiperComponent.prototype.updateInitSwiper = function (changedParams) {
      ...
      this._ngZone.runOutsideAngular(function () {
        var _d = _this.swiperRef,
          currentParams = _d.params,
          pagination = _d.pagination,
          navigation = _d.navigation,
          scrollbar = _d.scrollbar,
          virtual = _d.virtual,
          thumbs = _d.thumbs;
        ...
        if (
          changedParams.controller &&
          _this.controller &&
          _this.controller.control
        ) {
    ...
    SwiperComponent.prototype.updateSwiper = function (changedParams) {
      ...
      this._ngZone.runOutsideAngular(function () {
        ...
        for (var key in changedParams) {
          ...
          var newValue =
            (_b =
              (_a = changedParams[key]) === null || _a === void 0
                ? void 0
                : _a.currentValue) !== null && _b !== void 0
              ? _b
              : changedParams[key];
    ...
    SwiperComponent.prototype.calcLoopedSlides = function () {
      ...
      if (this.breakpoints) {
        var breakpoint = Swiper__default["default"].prototype.getBreakpoint(
          this.breakpoints,
        );
        var breakpointOnlyParams =
          breakpoint in this.breakpoints
    ...
    SwiperComponent.prototype.ngOnDestroy = function () {
      ...
      this._ngZone.runOutsideAngular(function () {
        var _a;
        (_a = _this.swiperRef) === null || _a === void 0
          ? void 0
          : _a.destroy(true, false);
      });
    };
    return SwiperComponent;
  })();
  SwiperComponent.ɵfac = i0__namespace.ɵɵngDeclareFactory({
    minVersion: "12.0.0",
    version: "12.2.2",
    ngImport: i0__namespace,
    type: SwiperComponent,
    deps: [
      { token: i0__namespace.NgZone },
      { token: i0__namespace.ElementRef },
      { token: i0__namespace.ChangeDetectorRef },
      { token: i0.PLATFORM_ID },
    ],
    target: i0__namespace.ɵɵFactoryTarget.Component,
  });
  SwiperComponent.ɵcmp = i0__namespace.ɵɵngDeclareComponent({
    minVersion: "12.0.0",
    version: "12.2.2",
    type: SwiperComponent,
    ...
    viewQueries: [
      ...
      {
        propertyName: "paginationElRef",
        first: true,
        predicate: ["paginationElRef"],
        descendants: true,
      },
    ],
    usesOnChanges: true,
    ...
    directives: [
      {
        type: i1__namespace.NgIf,
        selector: "[ngIf]",
        inputs: ["ngIf", "ngIfThen", "ngIfElse"],
      },
      {
        type: i1__namespace.NgClass,
        selector: "[ngClass]",
        inputs: ["class", "ngClass"],
      },
      {
        type: i1__namespace.NgTemplateOutlet,
        selector: "[ngTemplateOutlet]",
        inputs: ["ngTemplateOutletContext", "ngTemplateOutlet"],
      },
      {
        type: i1__namespace.NgForOf,
        selector: "[ngFor][ngForOf]",
        inputs: ["ngForOf", "ngForTrackBy", "ngForTemplate"],
      },
      {
        type: i1__namespace.NgSwitch,
        selector: "[ngSwitch]",
        inputs: ["ngSwitch"],
      },
      {
        type: i1__namespace.NgSwitchCase,
        selector: "[ngSwitchCase]",
        inputs: ["ngSwitchCase"],
      },
      { type: i1__namespace.NgSwitchDefault, selector: "[ngSwitchDefault]" },
    ],
    pipes: { async: i1__namespace.AsyncPipe },
      ...
      slidesEl: [
        {
          ...
          args: [
            ...
            { descendants: false, emitDistinctChangesOnly: true },
          ],
        },
      ],
      containerClasses: [
  ...
  SwiperModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({
    minVersion: "12.0.0",
    version: "12.2.2",
    ngImport: i0__namespace,
    type: SwiperModule,
  ...
  SwiperModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({
    minVersion: "12.0.0",
    version: "12.2.2",
    ngImport: i0__namespace,
    type: SwiperModule,
  ...
  SwiperModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({
    minVersion: "12.0.0",
    version: "12.2.2",
    ngImport: i0__namespace,
    type: SwiperModule,
