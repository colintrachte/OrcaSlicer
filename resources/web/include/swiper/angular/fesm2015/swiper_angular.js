...
class SwiperSlideDirective {
  ...
  _hasClass(classNames) {
    return classNames.some(
      (className) => this._classNames.indexOf(className) >= 0,
    );
  }
}
...
class SwiperComponent {
    ...
    this.slidesChanges = (val) => {
      ...
      if (!this.virtual) {
        if (this.loopedSlides) {
          this.prependSlides = of(
            this.slides.slice(this.slides.length - this.loopedSlides),
          );
  ...
  ngOnDestroy() {
    this._ngZone.runOutsideAngular(() => {
      var _a;
      (_a = this.swiperRef) === null || _a === void 0
        ? void 0
...
SwiperComponent.ɵcmp = i0.ɵɵngDeclareComponent({
  ...
  directives: [
    ...
    { type: i1.NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] },
    {
