...
function OnOrcaLoginOrRegister() {
  SendSimpleCommand("homepage_orca_login_or_register");
}
function OnOrcaLogOut() {
  SendSimpleCommand("homepage_orca_logout");
}
function SendMsg_GetOrcaLoginInfo() {
  SendSimpleCommand("get_orca_login_info");
}
...
function OnBambuLoginOrRegister() {
  SendSimpleCommand("homepage_bambu_login_or_register");
}
function OnBambuLogOut() {
  SendSimpleCommand("homepage_bambu_logout");
}
function SendMsg_GetBambuLoginInfo() {
  SendSimpleCommand("get_bambu_login_info");
}
...
function ShowStaffPick(ModelList) {
  ...
  for (let a = 0; a < PickTotal; a++) {
    ...
    strPickHtml +=
      ...
      ModelCover +
      '" /></div>' +
      '	<div  class="HotModel_NameText TextS1" title="' +
      ModelName +
      '">' +
      ModelName +
      "</div>" +
