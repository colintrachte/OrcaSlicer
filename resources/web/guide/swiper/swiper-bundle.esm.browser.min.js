      ...
      for (let s = 0, a = e.length; s < a; s += 1) {
        ...
        void 0 !== r &&
          ...
          (isObject(t[a]) && isObject(i[a])
            ...
            : !isObject(t[a]) && isObject(i[a])
              ? ((t[a] = {}),
                i[a].__swiper__ ? (t[a] = i[a]) : extend(t[a], i[a]))
              : (t[a] = i[a]));
      }
    }
  }
...
function Mousewheel({ swiper: e, extendParams: t, on: s, emit: a }) {
  ...
  function p(t) {
    return (
      ...
      !(
        ...
        now() - l < e.params.mousewheel.thresholdTime
      ) &&
      ((t.delta >= 6 && now() - l < 60) ||
        (t.direction < 0
  ...
  function u(t) {
    ...
    if (
      ("container" !== e.params.mousewheel.eventsTarget &&
        (d = $(e.params.mousewheel.eventsTarget)),
    ...
    if (
      ...
      (i =
        !!e.params.loop || !(m === e.minTranslate() || m === e.maxTranslate())),
      ...
      if (!i) {
        ...
        if (
          ...
          const s = o.length ? o[o.length - 1] : void 0,
            a = o[0];
          if (
            (o.push(t), s && (t.delta > s.delta || t.direction !== s.direction))
          )
            o.splice(0);
          else if (
            o.length >= 15 &&
  ...
  function h(t) {
    let s = e.$el;
    ("container" !== e.params.mousewheel.eventsTarget &&
      (s = $(e.params.mousewheel.eventsTarget)),
      s[t]("mouseenter", d),
      s[t]("mouseleave", c),
      s[t]("wheel", u));
  }
  ...
  function p() {
    ...
    0 !== s.length &&
      (e.params.uniqueNavElements &&
        ...
        ((s = e.$el.find(t.el)),
        s.length > 1 &&
          (s = s.filter((t) => $(t).parents(".swiper")[0] === e.el))),
...
function Zoom({ swiper: e, extendParams: t, on: s, emit: a }) {
  ...
  function g(t) {
    ...
    c.$imageEl && 0 !== c.$imageEl.length
      ? (s.gestures
          ? (i.scale = t.scale * o)
          : (i.scale = (c.scaleMove / c.scaleStart) * o),
        i.scale > c.maxRatio &&
          (i.scale = c.maxRatio - 1 + (i.scale - c.maxRatio + 1) ** 0.5),
        i.scale < a.minRatio &&
  ...
  function w(t) {
    ...
    if (!(a < c.slideWidth && i < c.slideHeight)) {
      ...
      (t.cancelable && t.preventDefault(),
        ...
        (u.x =
          (p.touchesCurrent.x - u.prevPositionX) /
          (Date.now() - u.prevTime) /
          2),
        (u.y =
          (p.touchesCurrent.y - u.prevPositionY) /
          (Date.now() - u.prevTime) /
          2),
  ...
  function k() {
    ...
    const s = e.support,
      ...
      r = S();
    (s.gestures
      ? (e.$wrapperEl.on(e.touchEvents.start, M, a),
        e.$wrapperEl.on(e.touchEvents.end, P, a))
      : "touchstart" === e.touchEvents.start &&
  ...
  function z() {
    ...
    const { passiveListener: a, activeListenerWithCapture: i } = T(),
      r = S();
    (s.gestures
      ? (e.$wrapperEl.off(e.touchEvents.start, M, a),
        e.$wrapperEl.off(e.touchEvents.end, P, a))
      : "touchstart" === e.touchEvents.start &&
        ...
        e.touchEvents.cancel &&
          e.$wrapperEl.off(e.touchEvents.cancel, r, v, a)),
      e.$wrapperEl.off(
        e.touchEvents.move,
        `.${e.params.zoom.containerClass}`,
        w,
...
function Lazy({ swiper: e, extendParams: t, on: s, emit: a }) {
  ...
  function l() {
    ...
    function c(e) {
      if (l) {
        if (
          t.children(`.${s.slideClass}[data-swiper-slide-index="${e}"]`).length
        )
          return !0;
  ...
  function o() {
    ...
    const s = e.params.lazy.scrollingElement
        ? $(e.params.lazy.scrollingElement)
        : $(t),
      a = s[0] === t,
...
function A11y({ swiper: e, extendParams: t, on: s }) {
  ...
  function u(t) {
    ...
    (e.navigation &&
      ...
      e.pagination &&
        a.is(classesToSelector(e.params.pagination.bulletClass)) &&
        a[0].click());
  }
  function h() {
  ...
  function g() {
    ...
    ((c = r),
      ...
      t.itemRoleDescriptionMessage &&
        o($(e.slides), t.itemRoleDescriptionMessage),
    ...
    (e.slides.each((s, a) => {
      ...
      h && h.length && f(h, r, t.nextSlideMessage),
      g && g.length && f(g, r, t.prevSlideMessage),
      m() &&
        e.pagination.$el.on(
          "keydown",
...
function EffectCube({ swiper: e, extendParams: t, on: s }) {
  ...
  effectInit({
    ...
    setTranslate: () => {
      ...
      d.shadow &&
        (c
          ? ((u = s.find(".swiper-cube-shadow")),
            0 === u.length &&
              ((u = $('<div class="swiper-cube-shadow"></div>')), s.append(u)),
            u.css({ height: `${i}px` }))
          : ((u = t.find(".swiper-cube-shadow")),
            0 === u.length &&
              ((u = $('<div class="swiper-cube-shadow"></div>')),
              t.append(u))));
      for (let e = 0; e < a.length; e += 1) {
        const t = a.eq(e);
        let s = e;
      ...
      s.transform(
        `translate3d(0px,0,${m}px) rotateX(${e.isHorizontal() ? 0 : h}deg) rotateY(${e.isHorizontal() ? -h : 0}deg)`,
      );
    },
    setTransition: (t) => {
    ...
    setTranslate: () => {
      ...
      for (let i = 0; i < t.length; i += 1) {
        ...
        if (
          ...
          (0 === t.length &&
            (t = createShadow(a, r, e.isHorizontal() ? "left" : "top")),
            0 === s.length &&
              (s = createShadow(a, r, e.isHorizontal() ? "right" : "bottom")),
    ...
    setTranslate: () => {
      ...
      for (let s = 0; s < t.length; s += 1) {
        ...
        if ((m && f.shadow) || !m) {
          ...
          if (
            (0 === e.length && f.shadow && (e = createShadow(r, i)), e.length)
          ) {
