...
declare class Swiper extends SvelteComponentTyped<
  SwiperProps,
  {
    ...
    lazyImageLoad: CustomEvent<
      [swiper: SwiperClass, slideEl: HTMLElement, imageEl: HTMLElement]
    >;
    /**
    ...
    scrollbarDragStart: CustomEvent<
      [swiper: SwiperClass, event: MouseEvent | TouchEvent | PointerEvent]
    >;
    ...
    paginationRender: CustomEvent<
      [swiper: SwiperClass, paginationEl: HTMLElement]
    >;
    ...
    _slideClass: CustomEvent<
      [swiper: SwiperClass, slideEl: HTMLElement, classNames: string]
    >;
    ...
    beforeTransitionStart: CustomEvent<
      [swiper: SwiperClass, speed: number, internal: any]
    >; // what is internal?
    /**
