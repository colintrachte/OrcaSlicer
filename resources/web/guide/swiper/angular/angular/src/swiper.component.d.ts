...
export declare class SwiperComponent implements OnInit {
  ...
  s_beforeSlideChangeStart: EventEmitter<
    SwiperEvents["beforeSlideChangeStart"]
  >;
  ...
  s_slideChangeTransitionEnd: EventEmitter<
    SwiperEvents["slideChangeTransitionEnd"]
  >;
  s_slideChangeTransitionStart: EventEmitter<
    SwiperEvents["slideChangeTransitionStart"]
  >;
  s_slideNextTransitionEnd: EventEmitter<
    SwiperEvents["slideNextTransitionEnd"]
  >;
  s_slideNextTransitionStart: EventEmitter<
    SwiperEvents["slideNextTransitionStart"]
  >;
  s_slidePrevTransitionEnd: EventEmitter<
    SwiperEvents["slidePrevTransitionEnd"]
  >;
  s_slidePrevTransitionStart: EventEmitter<
    SwiperEvents["slidePrevTransitionStart"]
  >;
  s_slideResetTransitionStart: EventEmitter<
    SwiperEvents["slideResetTransitionStart"]
  >;
  s_slideResetTransitionEnd: EventEmitter<
    SwiperEvents["slideResetTransitionEnd"]
  >;
  ...
  s_slidesGridLengthChange: EventEmitter<
    SwiperEvents["slidesGridLengthChange"]
  >;
