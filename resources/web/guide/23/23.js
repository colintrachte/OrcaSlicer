...
function TestCustomFilaments() {
  let strTest =
    '{"command":"update_custom_filaments","data":[{"id":"P0c71f94","name":"AMOLEN ABS 222"},{"id":"P19cc6c5","name":"PrimaSelect PLA 231654"},{"id":"P93a5c3b","name":"3DJAKE PLA 111"}],"sequence_id":"2000"}';
...
function UpdateCustomFilaments(CFList) {
  ...
  for (let n = 0; n < nTotal; n++) {
    ...
    let strAdd =
      ...
      '<a  class="CFilament_Name" title="' +
      F_name +
      '">' +
      F_name +
      "</a><img onClick=\"CFEdit('" +
      F_id +
      '\')" class="CFilament_EditBtn" src="../../image/edit.svg" />' +
      "</div>";
